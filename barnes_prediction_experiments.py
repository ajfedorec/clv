...
def fit_model(Y, U, T, model):
    ...
    for fold in range(folds):
        ...
        parameter_filename = "pkl/barnes_prediction_parameters-{}".format(fold)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
       print("USAGE: python barnes_prediction_experiments.py [MODEL]")
       exit(1)
    model = sys.argv[1]
    fit_model(Y=Y_adj, U=U, T=T, model=model)
